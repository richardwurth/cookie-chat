...
this.getMessages = () => $http.get('https://practiceapi.devmounta.in/api/chats');
  ...
  this.postMessages = (newMessage) => $http.post('https://practiceapi.devmounta.in/api/chats',{message: newMessage});
